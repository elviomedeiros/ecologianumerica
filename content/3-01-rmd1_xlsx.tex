...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, left=2mm, opacitybacktitle=0.6, opacityback=0, rightrule=.15mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, titlerule=0mm, breakable, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Mensagens de erro e avisos no R}, bottomrule=.15mm, colback=white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, left=2mm, opacitybacktitle=0.6, opacityback=0, rightrule=.15mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-color!10!white, titlerule=0mm, breakable, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, title={Attention}, bottomrule=.15mm, colback=white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-caution-color-frame, left=2mm, opacitybacktitle=0.6, opacityback=0, rightrule=.15mm, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, titlerule=0mm, breakable, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Porque preferir códigos e scripts do que mouse e menus de janelas no R}, bottomrule=.15mm, colback=white, toprule=.15mm]
