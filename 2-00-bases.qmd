...
```{r}
#| label: tbl-200abr
#| tbl-cap: Nomenclatura das matrizes em AMD em relação aos atributos das colunas e suas abreviações nos códigos do R. 
#| echo: false
#| purl: false
#| warning: false
m_ <- tibble::tribble(
...
library(knitr)
library(kableExtra)
m_x <- kable(m_, row.names = FALSE, align = c("l", "c", "c"), booktabs = TRUE, format = if (knitr::is_latex_output()) "latex" else "html")
