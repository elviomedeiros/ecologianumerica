...
gt_tbl <- cols_width(
  gt_tbl,
  `Arquivo (.xlsx)` ~ px(100),
  `Tipo de matriz` ~ px(100),
  Descrição ~ px(250),
  `Tipo de dados` ~ px(200))
gt_tbl
```
...
#| echo: false
#| purl: false
knitr::purl(input = "D:/Elvio/OneDrive/Disciplinas/_EcoNumerica/3.R_Quarto/ecologianumerica/content/3-01-rmd1_xlsx.qmd",
            output = "D:/Elvio/OneDrive/Disciplinas/_EcoNumerica/3.R_Quarto/ecologianumerica/scripts/script-3-01-rmd1_xlsx.txt", documentation = 0)
Script <- readLines("D:/Elvio/OneDrive/Disciplinas/_EcoNumerica/3.R_Quarto/ecologianumerica/scripts/script-3-01-rmd1_xlsx.txt")
Script <- Script[Script != ""]
writeLines(Script, "D:/Elvio/OneDrive/Disciplinas/_EcoNumerica/3.R_Quarto/ecologianumerica/scripts/script-3-01-rmd1_xlsx.txt")
cat(Script, sep = "\n")
```
